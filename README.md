...
<br>
<br>
Branch **random_python** is about how we generate fake data instances for tables not in the *Kaggle*.
Some of them need to be stored in .csv file inside branch **data_random**, the rest are in the *insert_data.sql*.
